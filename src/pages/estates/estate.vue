                ...
                <v-card min-height="250px" class="mx-1">
                    <v-card-text class="font-weight-bold">
                        ...
                        >
                            ...
                            <a
                                :href="'/estate-offices/' + item.office.id"
                                target="_blank"
                            >
                                {{ item.office.name }}
                            </a>
            ...
            <v-col sm="12" md="4">
                <v-card min-height="250px" class="mx-1">
                    <v-card-text class="font-weight-bold">
                        ...
                        <div
                            class="d-flex justify-space-between"
                            v-if="item.period_type"
                        >
                            <span> الفترة: </span>
                            <span>
                                {{ item.period_type.name_ar.split("|")[0] }}
                            </span>
                        </div>
                        <div
                            class="d-flex justify-space-between"
                    ...
                    <v-card-text>
                        <v-row>
                            <v-col
                                ...
                                :key="index"
                                :class="{
                                    'd-none': image.type != 'estate_image'
                                }"
                            >
                                <v-card
                    ...
                    <v-card-text>
                        <v-row>
                            <v-col
                                ...
                                :key="index"
                                :class="{
                                    'd-none': image.type != 'street_image'
                                }"
                            >
                                <v-card
