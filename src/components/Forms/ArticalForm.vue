        ...
        <v-stepper v-model="e1">
          <v-stepper-header>
            <template v-for="n in steps">
              <v-stepper-step :key="`${n}-step`" :complete="e1 > n" :step="n" editable edit-icon="mdi-check">
                الخطوة
              </v-stepper-step>
              ...
              <v-form>
                <v-row>
                  <v-col cols="12" sm="12" md="12">
                    <Input label="عنوان المقال" :model="form.title" :errorMessages="titleErrors" @changeValue="
                      (val) => {
                        form.title = val;
                        $v.form.title.$touch();
                      }
                  ...
                  <v-col cols="12" sm="12" md="12">
                    <Switcher label="هل المقال مميز" attr="featured" :model="form.featured" @switcher="
                      (val) => {
                  ...
                  <v-col cols="12" sm="12" md="12">
                    ...
                    <VueEditor v-model="form.body" :errorMessages="bodyErrors" @changeValue="
                    (val) => {
                      form.body = val;
                      $v.form.body.$touch();}" />
              ...
              <v-form>
                <v-row>
                  <v-col cols="12" sm="12" md="12">
                    ...
                    <ImagesUploader :images="Images" label="تحميل صور المقال" @updateImages="updateImages">
                    </ImagesUploader>
                    <v-card-actions>
                      <v-spacer></v-spacer>
                      <div>
