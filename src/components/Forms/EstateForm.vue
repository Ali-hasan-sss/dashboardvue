    ...
    computed: {
        ...
        estateImages() {
            ...
            if (this.form.images.data.length > 0) {
                images = this.form.images.data.filter(
                    x => x.type == "estate_image"
                );
            }
            return images;
        },
        ...
        save() {
            ...
            if (!this.$v.form.$invalid) {
                ...
                this.floor_edited_images_ids.length == 0
                    ...
                    : this.floor_edited_images_ids
                          .reverse()
                          .forEach(function (value) {
                              formdata.append(
                                  "floor_plan_edited_images_ids[]",
                                  value
                              );
                          });
